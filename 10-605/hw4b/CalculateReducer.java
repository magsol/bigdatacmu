...
public class CalculateReducer extends Reducer<Text, Text, DoubleWritable, Text> {
    ...
    public static double probability(long x, long total, long vocab) {
        return ((double)x + 1.0) / ((double)total + (double)vocab);
    }
     ...
     * @return
     */
    public static double informativeness(long Bxy, long Cxy, long bgTotalPhrases,
            long bgPhraseVocab, long fgTotalPhrases, long fgPhraseVocab) {
     ...
     * @return
     */
    public static double phraseness(long Cxy, long Cx, long Cy, long fgTotalPhrases,
            long fgPhraseVocab, long fgTotalWords, long fgWordVocab) {
        double p = CalculateReducer.probability(Cxy, fgTotalPhrases, fgPhraseVocab);
    ...
    public void reduce(Text key, Iterable<Text> values, Context context)
        ...
        double phraseness = CalculateReducer.phraseness(Cxy, Cx, Cy,
                fgTotalPhrases, fgPhraseVocab, fgTotalWords, fgWordVocab);
        
        double informativeness = CalculateReducer.informativeness(Bxy, Cxy,
                bgTotalPhrases, bgPhraseVocab, fgTotalPhrases, fgPhraseVocab);
